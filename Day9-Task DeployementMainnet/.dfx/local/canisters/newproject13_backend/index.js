...
import { idlFactory } from './newproject13_backend.did.js';
export { idlFactory } from './newproject13_backend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_NEWPROJECT13_BACKEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./newproject13_backend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the newproject13_backend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./newproject13_backend.did.js")._SERVICE>}
 */
export const newproject13_backend = createActor(canisterId);
